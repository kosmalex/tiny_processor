...
add wave -noupdate -expand -group VGA_driver /tbq/tt_um_tiny_processor/vga_driver_0/hsync_out
add wave -noupdate -expand -group VGA_driver /tbq/tt_um_tiny_processor/vga_driver_0/vsync_out
add wave -noupdate /tbq/tt_um_tiny_processor/vga_driver_0/hcnt
add wave -noupdate /tbq/tt_um_tiny_processor/vga_driver_0/vcnt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4335000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {8620800 ps}
