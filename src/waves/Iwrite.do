...
add wave -noupdate -expand -group SPI /tbq/tt_um_tiny_processor/master_wr
...
add wave -noupdate -expand -group Dcache -radix decimal -childformat {{{/tbq/tt_um_tiny_processor/dcache/mem[0]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[1]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[2]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[3]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[4]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[5]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[6]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[7]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[8]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[9]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[10]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[11]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[12]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[13]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[14]} -radix decimal} {{/tbq/tt_um_tiny_processor/dcache/mem[15]} -radix decimal}} -subitemconfig {{/tbq/tt_um_tiny_processor/dcache/mem[0]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[1]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[2]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[3]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[4]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[5]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[6]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[7]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[8]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[9]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[10]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[11]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[12]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[13]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[14]} {-radix decimal} {/tbq/tt_um_tiny_processor/dcache/mem[15]} {-radix decimal}} /tbq/tt_um_tiny_processor/dcache/mem
...
update
WaveRestoreZoom {0 ps} {269394 ps}
