...
add wave -noupdate -expand -group Device /tb/device_0/clk
add wave -noupdate -expand -group Device /tb/device_0/rst
add wave -noupdate -expand -group Device /tb/device_0/mosi
add wave -noupdate -expand -group Device /tb/device_0/cs
add wave -noupdate -expand -group Device /tb/device_0/miso
add wave -noupdate -expand -group Device /tb/device_0/register
add wave -noupdate -expand -group Device /tb/device_0/pos_edge
add wave -noupdate -expand -group Device /tb/device_0/neg_edge
add wave -noupdate -expand -group Device /tb/device_0/cs_reg
add wave -noupdate -expand -group Device /tb/device_0/counter
add wave -noupdate -expand -group Device /tb/device_0/mem
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {16036716 ps} 0}
...
update
WaveRestoreZoom {24434593 ps} {25148496 ps}
