...
##7 segment display
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { s7[0] }]; #IO_L24N_T3_A00_D16_14 Sch=ca
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { s7[1] }]; #IO_25_14 Sch=cb
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { s7[2] }]; #IO_25_15 Sch=cc
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { s7[3] }]; #IO_L17P_T2_A26_15 Sch=cd
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { s7[4] }]; #IO_L13P_T2_MRCC_14 Sch=ce
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { s7[5] }]; #IO_L19P_T3_A10_D26_14 Sch=cf
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { s7[6] }]; #IO_L4P_T0_D04_14 Sch=cg
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { s7[7] }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
...
##Pmod Headers
##Pmod Header JA
# set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { uio_out[0] }]; #IO_L20N_T3_A19_15 Sch=ja[1]
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { uio_out[1] }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
# set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { uio_out[2] }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
# set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { uio_out[3] }]; #IO_L18N_T2_A23_15 Sch=ja[4]
# set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { uio_out[4] }]; #IO_L16N_T2_A27_15 Sch=ja[7]
# set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { uio_out[5] }]; #IO_L16P_T2_A28_15 Sch=ja[8]
# set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { uio_out[6] }]; #IO_L22N_T3_A16_15 Sch=ja[9]
# set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { uio_out[7] }]; #IO_L22P_T3_A17_15 Sch=ja[10]
